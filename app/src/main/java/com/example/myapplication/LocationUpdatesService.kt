...
class LocationUpdatesService : Service() {
    ...
    override fun onCreate() {
        ...
        if (checkGPSIsOn(this)){
            val locationListener = MyLocationListener(this) { latitude, longitude, locality, countryName ->
                ...
                if (sharedPreferences.getString(PLACE_ID, "") != getLocation.provider) {
                    ...
                    if (distance <= locationRange) {
                        ...
                        if (isAppIsInBackground(applicationContext)) {
                            ...
                            sendNotification(this, getLocation.provider.orEmpty())
                        } else {
